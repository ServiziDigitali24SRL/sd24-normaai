...
> In tre minuti ti mostro perché può diventare il punto d'accesso alla giustizia per milioni di italiani.

**[SLIDE 2 — Il problema · "A chi mi rivolgo? Quanto mi costa?"]**
> Partiamo da un fatto.
> Ogni anno milioni di cittadini, imprenditori e turisti hanno un problema legale.
> E si fermano sempre alle stesse due domande: a chi mi rivolgo, e quanto mi costa.
> Così rinunciano ai propri diritti.
> Dall'altra parte, migliaia di avvocati — soprattutto i giovani — non trovano clienti.
> Domanda e offerta esistono. Ma non si incontrano.

**[SLIDE 3 — La soluzione · split Cittadino ↔ Avvocato]**
> NormaAI è una piattaforma a due lati che usa l'AI per farle incontrare.
> Da un lato il cittadino. Dall'altro l'avvocato.

**[SLIDE 4 — normaai.it / agente vocale in azione]**
> Per il cittadino è semplice: parla.
> Un agente vocale risponde gratis, a chiunque, su qualsiasi questione legale.
> E ogni risposta è ancorata alla legge vera, con la fonte citata. Niente invenzioni.

**[SLIDE 5 — Conversione · "9 €"]**
> Finché il problema si risolve con un'informazione, è gratis.
...
> Risultato: il cittadino riceve fino a quattro pareri al telefono.
...
### Varianti di apertura (A/B sui primi 5 secondi)
- **Numero shock:** *"In Italia milioni di persone ogni anno rinunciano a un loro diritto legale. Non perché abbiano torto — ma perché non sanno a chi rivolgersi. NormaAI risolve esattamente questo."*
- **Categoria nota:** *"Conosci avvocatoflash? Bene. Immagina la stessa cosa, ma dove un'AI risponde gratis a tutti prima ancora che entri un avvocato. Questa è NormaAI."*
