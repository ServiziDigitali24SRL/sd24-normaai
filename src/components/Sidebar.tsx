    ...
    <div ref={ref} className="relative">
      {open && (
        <div className={`absolute bottom-full left-0 w-full mb-[2px] ${sb.popup} rounded-xl shadow-lg overflow-hidden z-50`}>
          ...
          <MenuBtn onClick={() => { setOpen(false); onOpenModal("piani"); }} icon={<svg viewBox="0 0 24 24"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z" /><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z" /></svg>} label="Il mio piano" sub={roleLabel === "Cittadino" ? "9€/mese" : roleLabel === "Impresa" ? "29€/mese" : roleLabel === "Professionista" ? "29€/mese" : undefined} />
