/**
 * Footer condiviso brand cream/serif legal-warm NormaAI.
 * Usato da homepage (`src/app/page.tsx`), diario (`/come_ho_costruito_norma`),
 * e tutte le route che vogliono il branding unificato.
 *
 * Note font: dipende da CSS variables --font-instrument-serif e
 * --font-jetbrains-mono caricate dal root layout (`src/app/layout.tsx`).
 */

interface SiteFooterProps {
  /**
   * Timestamp opzionale per "ultimo aggiornamento". Se assente non mostra il
   * badge — utile per pagine statiche dove non c'è snapshot live a cui
   * riferirsi.
   */
...
export function SiteFooter({ lastUpdateLabel }: SiteFooterProps = {}) {
  return (
