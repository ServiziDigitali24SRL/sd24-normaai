      ...
      <div className="p-7 max-h-[85vh] overflow-y-auto">
        ...
        {view === "disconnected" && (
          <div>
            ...
            <button
              ...
              disabled={connecting}
              className="mt-6 w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-[#2a2a2a] bg-white text-[#333] font-semibold text-[13px] cursor-pointer hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
            ...
            <div className="mt-4 text-[10px] text-[#444] leading-[1.5]">
        ...
        {(view === "connected" || view === "analyzing") && (
          <div>
            ...
            {loadingChats ? (
              <div className="py-8 text-center text-[12px] text-[#555]">Caricamento chat...</div>
            ) : chats.length === 0 ? (
              <div className="py-6 text-center">
                <div className="text-[12px] text-[#555] mb-2">Nessuna chat trovata</div>
              ...
              <div className="space-y-2 max-h-[300px] overflow-y-auto">
                {chats.map(chat => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-xl border border-[#1e1e1e] bg-[#0f0f0f] hover:border-[#333] transition-colors cursor-pointer disabled:opacity-50"
                  >
                    <div className="flex items-center justify-between mb-1">
                      <div className="text-[13px] text-[#ccc] font-medium truncate">
                        {chat.chatName}
                      </div>
                      <div className="text-[10px] text-[#444] shrink-0 ml-2">
                        {chat.date}
                      </div>
                    </div>
            ...
            <button
              ...
              className="mt-4 w-full bg-[#111] text-[#888] font-medium text-[12px] py-[8px] rounded-xl border border-[#222] cursor-pointer hover:border-[#333] transition-colors disabled:opacity-50"
            >
              Aggiorna chat
            </button>
