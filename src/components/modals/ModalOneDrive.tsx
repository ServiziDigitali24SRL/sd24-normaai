              ...
              <div className="mt-5 space-y-2">
                ...
                {files.map((f, i) => (
                  <a
                    ...
                    className="block p-3 rounded-lg border border-[#1e1e1e] bg-[#0a0a0a] hover:border-[#333] transition-colors no-underline"
                  >
                    <div className="text-[13px] text-[#ccc] truncate">{f.name}</div>
                    <div className="flex items-center gap-3 mt-1">
                      <span className="text-[10px] text-[#444]">{f.mimeType}</span>
                      {f.lastModified && (
