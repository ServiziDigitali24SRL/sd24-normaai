...
export const ORB_PERSONALITIES: readonly OrbPersonality[] = [
  {
    ...
    preview: "linear-gradient(135deg, #E6DFCF, #D44A2A)",
  ...
  },
  {
    ...
    preview: "linear-gradient(135deg, #131A30, #3060A0)",
  ...
  },
  {
    ...
    preview: "linear-gradient(135deg, #C8DFC0, #40A030)",
  ...
  },
  {
    ...
    preview: "linear-gradient(135deg, #D8C0F0, #C040A0)",
  ...
  },
  {
    ...
    preview: "linear-gradient(135deg, #B8D4F0, #4A90E2 40%, #1E5BA8)",
