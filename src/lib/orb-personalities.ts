...
export const ORB_PERSONALITIES: readonly OrbPersonality[] = [
  {
    ...
    preview: "radial-gradient(circle at 33% 28%, #FFFDE8 0%, #F7CA50 35%, #D98A1A 70%, #7C4210 100%)",
  ...
  },
  {
    ...
    preview: "radial-gradient(circle at 33% 28%, #AAC8F0 0%, #2858B8 35%, #0D2270 70%, #040B22 100%)",
  ...
  },
  {
    ...
    preview: "radial-gradient(circle at 33% 28%, #CCEECC 0%, #3CAE62 35%, #186838 70%, #072A16 100%)",
  ...
  },
  {
    ...
    preview: "radial-gradient(circle at 33% 28%, #FAE8FF 0%, #C455EC 35%, #7218B0 70%, #320870 100%)",
  ...
  },
  {
    ...
    preview: "radial-gradient(circle at 33% 28%, #B0DCFA 0%, #2A88DE 35%, #0C52B0 70%, #041E40 100%)",
