/**
 * Homepage NormaAI — vetrina per incubatori e investitori.
 *
 * Pagina statica (immagini + testo), brand cream/serif legal-warm. Contiene:
 * descrizione del progetto, come è stato costruito, preview statica dell'agente
 * e del marketplace lead (Tinder), unit economics, il pitch (video + PDF),
 * link GitHub, Business Plan gated e pulsante WhatsApp flottante.
 *
 * La precedente landing cittadini (LandingHero) è preservata su /home.
...
export const metadata: Metadata = {
  title: 'NormaAI — la legge italiana, accessibile a tutti',
  description:
    'NormaAI — assistenza legale AI gratuita per tutti + marketplace "Tinder dei legali". Corpus di oltre 1 milione di documenti normativi. Pitch, video e Business Plan.',
};
  ...
  return (
    <div className="bg-[#F6F2EA] text-[#13110F]" style={{ fontFamily: 'var(--font-inter-tight), system-ui, sans-serif' }}>
      ...
      <section className="mx-auto max-w-5xl px-6 pt-24 pb-16">
        ...
        {/* Video pitch (hero) */}
        <div className="mt-14 overflow-hidden rounded-lg border border-[#D8CFBC] bg-black">
          <video
            controls
            playsInline
            preload="metadata"
            poster="/pitch/normaai-pitch-cover.jpg"
            className="aspect-video w-full"
          >
            <source src="/pitch/normaai-pitch-3min.mp4" type="video/mp4" />
          </video>
        </div>
        <p className="mt-3 text-center text-[12px] uppercase tracking-[0.2em] text-[#9A8E83]" style={mono}>
          Il pitch in 3 minuti
        </p>
      </section>
      ...
      <section className="border-t border-[#D8CFBC] bg-[#FBF8F1]">
        <div className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="overflow-hidden rounded-lg border border-[#D8CFBC] bg-black">
              <video
                controls
                playsInline
                preload="none"
            ...
            <div>
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-[#3D3530]">
                Il video racconta il progetto end-to-end: problema, soluzione a due lati, numeri e ask. Tutti i dettagli sono nel pitch in PDF.
              </p>
